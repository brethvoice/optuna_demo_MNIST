...
from numpy import zeros, mean, min
from gc import collect as take_out_trash


class PrunedEvaluateMNIST:
    ...
    def __init__(
        ...
        self.adam_epsilon = adam_epsilon_multiplier * epsilon()  # n * epsilon(), n int from 1 to 10000 (1)
        ...
        self.batch_size = 2 ** batch_size_power_of_two  # powers of 2 (32)
